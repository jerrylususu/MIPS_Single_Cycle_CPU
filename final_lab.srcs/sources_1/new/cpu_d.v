...
module cpu_d(highclk, rst, led2N4, switch2N4);
...
wire[5:0] ifetchdebug;


assign led2N4[4:0] = PC[4:0];
assign led2N4[9:5] = PC_plus_4_out[4:0];
assign led2N4[23] = clock;
assign led2N4[16:10] = {Branch, nBranch, Zero, Jrn, Jal, Jmp, rst};

assign led2N4[22:17] = ifetchdebug;

// 各个模块的详细组装信息
Ifetc32 Ifetc32(Instruction,PC_plus_4_out,Add_result,Read_data_1,Branch,nBranch,Jmp,Jal,Jrn,Zero,clock,rst,opcplus4,
PC, next_PC, PC_plus_4,ifetchdebug);
