...
HD_PWD='C:/Projects/cs202/vivado/final_lab/final_lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clockregtest2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clockregtest2.tcl -notrace
