...
HD_PWD='C:/Projects/cs202/vivado/final_lab/final_lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clockregtest2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clockregtest2.tcl
